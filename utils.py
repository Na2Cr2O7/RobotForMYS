...
SIZE_=10,20
#getsize is deleted in pillow 8.0.0
def sort_chars(char_list, font, language):
    if language == "chinese":
        char_width, char_height = SIZE_#font.getsize("制")
    elif language == "korean":
        char_width, char_height = SIZE_#font.getsize("ㅊ")
    elif language == "japanese":
        char_width, char_height = SIZE_#font.getsize("あ")
    elif language in ["english", "german", "french", "spanish", "italian", "portuguese", "polish"]:
        char_width, char_height =SIZE_# font.getsize("A")
